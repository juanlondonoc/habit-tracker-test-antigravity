...
export const HabitItem: React.FC<HabitItemProps> = ({ habit, selectedDate, showActions = false }) => {
        ...
        >
            ...
            <div className="flex flex-col pl-3 gap-1 flex-1">
                ...
                <div className="flex items-center justify-between">
                    <h3 className={cn(
                        "font-medium text-base leading-none truncate pr-2",
                        completed && !showActions ? "text-white line-through decoration-white/20" : "text-gray-200"
                    )}>
                        {habit.name}
                    </h3>
                    ...
                    {showActions && (
                        <div className="flex items-center ml-2 shrink-0">
                            <Button variant="ghost" size="icon" onClick={(e) => { e.stopPropagation(); setIsEditing(true); }} className="h-8 w-8">
                                <Edit2 className="w-4 h-4 text-gray-400" />
                            </Button>
                            <Button variant="ghost" size="icon" onClick={(e) => { e.stopPropagation(); setIsDeleting(true); }} className="h-8 w-8">
                ...
                {!showActions && habit.type === 'quantitative' && habit.target && (
